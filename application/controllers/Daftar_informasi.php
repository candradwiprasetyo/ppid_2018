...
class Daftar_informasi extends CI_Controller
{
    ...
    {   
        ...
        $data['title'] = "Daftar Informasi PPID Prov Jawa Timur";
        $meta['title'] = 'Daftar Informasi PPID Prov Jawa Timur';
        $data['view_all'] = base_url().'indeks/daftar_informasi';

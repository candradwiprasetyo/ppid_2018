...
class Layanan_informasi extends CI_Controller
{
    ...
    {   
        ...
        $data['title'] = "Layanan Informasi PPID Prov Jawa Timur";
        $meta['title'] = 'Layanan Informasi PPID Prov Jawa Timur';
        $data['view_all'] = base_url().'indeks/layanan_informasi';
